...
def run_training():
    ...
    BATCH_SIZE = 64
    N_EPOCHS = 200  # Đặt cao lên, Early Stopping sẽ tự dừng
    ...
    train_src = [item['vi'] for item in dataset['train']][:10]
    train_tgt = [item['en'] for item in dataset['train']][:10]
    ...
    # early_stopping = EarlyStopping(patience=PATIENCE, verbose=True, path='weights/')
